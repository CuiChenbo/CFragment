...
public class FragmentShowHideClipChildrenActivity extends AppCompatActivity {
    ...
    protected void initList() {
        ...
        findViewById(R.id.iv).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(FragmentShowHideClipChildrenActivity.this,"嗯哼，点我！！！",Toast.LENGTH_SHORT).show();
            }
        });
    }
